...
$(document).ready(function(){
	setTimeout("recipe_timer()",5000); // 3초후 
})
function recipe_timer(){
	location.replace("recipe_list");
}
...
<app-root>
  ...
  <form class="writeForm" action="recipe_list">
  <!-- Page Content -->
  <div class="container">
	...
	<div class="jumbotron my-4">
			...
			<div class="payOkWrap">
					...
					<h1> 레시피 등록이 완료되었습니다. </h1>
					<h1> 잠시후 레시피 목록으로 이동합니다 </h1>
