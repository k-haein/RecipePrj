...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/recipe_detail_title.css" media="all" />
      ...
      <div class="row" >
        <div class="detail_div">
          ...
          <article class="post-single">
            ...
            <h2 class="title">${detail.recipe_title}</h2><br/>
            <span><h5>${detail.recipe_content}</h5></span><br/>
            <div class="post-meta">
         
              <span><i class="fas fa-concierge-bell"></i>    <d12>${detail.scrap_cnt} Scrap</d12></span>
              <span> <i class="far fa-user"></i>    <d12> Posted by ${detail.mem_nickname}</d12> </span>
              <div class="recipe-duration">
                  <span><i class="fas fa-stopwatch"></i>   <d12>요리시간 ${detail.recipe_time}</d12></span>
              </div>
              <span> <i class="far fa-level"></i>   <d12>난이도 ${detail.recipe_level}</d12></span>
            ...
            <div class="post-content">
            	...
            	<c:set var="str3" value="${list.step}"/>

                           <c:set var="mate_name" value="${fn:replace(str1, ',', '<br>')}"/>
                           
                           <c:set var="mate_cnt" value="${fn:replace(str2, ',', '<br>')}"/>
                           
                           <c:set var="step" value="${fn:replace(str3, ',', '<br><br><d>&emsp;&nbsp;')}"/>
              <div class="recipe-ingredientss"  id="mate_title" >
                <h4>재료 준비</h4>
                
                	<div id="mate_name">
                	
                   <span><d11>${mate_name}</d11> </span>
                                   	
                	</div>
                   
                   <div id="mate_cnt">
                    <span><d11>${mate_cnt}</d11> </span>
              ...
              <div class="recipe-instructionss" id="steplist">
                <h4>조리 방법</h4><br>
                <ul>
                  <li>
                    <p> 
