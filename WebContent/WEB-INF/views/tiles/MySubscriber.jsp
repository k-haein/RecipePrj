			        ...
			        <div class="col-lg-10">
			          ...
			          <div class="row masonry">
			            ...
			            <div class="col-lg-6 col-md-6 masonry-item">
			              <article class="post">
			                <div class="post-thumbnail">
			                  <img src="${pageContext.request.contextPath}/resources/image/member_upload/${subscriberList.member_asso.mem_pic}"  style="height: 100px; width: 100px;" 
			                  ...
			                  <div class="post-meta">
			                    <span>${subscriberList.subscribe_uploadtime}</span>
			                    <span> 넘버 : ${subscriberList.kind_tag_no}</span>
			                  </div>
			                </div>
			                <div class="post-categories">
			                  <a href=""> ${subscriberList.member_asso.mem_grade_no}</a>
			                  <a href=""> <c:set var="kind_tag_no" value="${subscriberList.member_asso.kind_tag_no}" />
			                ...
			                <div class="post-body">
			                  <h5 class="post-title">${subscriberList.member_asso.mem_nickname}</h5>
			                   <p class="post-text">이메일 : ${subscriberList.member_asso.mem_email}</p>
			                </div>
			            ...
			            <!-- Post End -->
							...
							<%-- page 처리  --%>
							<%@include file="pageProcess_subscriber.jsp" %>				            
				            </ul>
