                                            ...
                                            <div class="col-md-6 ml-auto mr-auto">
                                               <div class="profiles p-3 my-4 rounded text-center shadow-sm">
                                                    <div class="avatars">
                                                       ...
                                                       onerror="this.src='https://image.ibb.co/jw55Ex/def_face.jpg'">
                                                    </div>
                                                    <div class="names">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6 d-flex justify-content-center align-items-center">
                                                                <div class="numbers">
                                                                    <p>클래스 수강수</p>
                                                                    <c:choose>
																		<c:when test="${myClientCount == null}">0</c:when>
																		<c:when test="${myClientCount != null}">${myClientCount}</c:when>
																	</c:choose>
                                                                </div>
                                                            </div>
                                                        </div>
